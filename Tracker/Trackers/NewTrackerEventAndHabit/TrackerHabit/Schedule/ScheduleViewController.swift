...
final class ScheduleViewController: UIViewController, ViewConfigurable {
    ...
    private let titlePage = NSLocalizedString("title_schedule_page", comment: "")
    ...
    private lazy var button: UIButton = {
        let button = UIButton()
        button.setTitle(textCreateButton, for: .normal)
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            tableView.heightAnchor.constraint(equalToConstant: CGFloat(75 * weekDays.count)),
